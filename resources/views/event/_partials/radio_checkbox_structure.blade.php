    ...
    <table class="table table-bordered table-sm option-table">
        ...
        <tr id="row_1">
            ...
            <td class="text-center">
                <div class="form-check">
                    <input class="form-check-input required-field" name="{{ $dataType . '[' . $rowNo . '][' . $sectionNo . '][opt][1][checked]' }}" type="checkbox" value="1">
                    <label class="form-check-label">Yes</label>
                </div>
            </td>
            <td>
                <input type="text" class="form-control required-field" name="{{ $dataType . '[' . $rowNo . '][' . $sectionNo . '][opt][1][custom_id]' }}">
            </td>
            <td>
