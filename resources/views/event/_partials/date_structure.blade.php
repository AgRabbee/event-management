...
<div class="form-group mb-3">
    ...
    <input type="date" class="form-control required-field" id="min_limit" name="{{ $dataType . '[' . $rowNo . '][' . $sectionNo . '][min_limit]'}}" placeholder="Enter your minimum date limit">
</div>
<div class="form-group mb-3">
    <label class="mb-1" for="max_limit">Maximum Limit</label>
    <input type="date" class="form-control required-field" id="max_limit" name="{{ $dataType . '[' . $rowNo . '][' . $sectionNo . '][max_limit]'}}" placeholder="Enter your maximum date limit" value="{{ date('Y-m-d')
     }}">
</div>
