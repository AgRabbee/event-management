    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card border border-olive">
                <div class="card-header bg-olive">Edit Event</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-sm" id="name" maxlength="100" aria-labelledby="event_name" placeholder="Enter name" value="{{ old('name', $event->name)
                                    }}">
                                    @error('name')
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="short_desc" class="form-control form-control-sm textarea short-textarea no-resize" id="short_desc" maxlength="100" cols="30" rows="1">{{ old('short_desc', $event->short_desc)
                                    }}</textarea>
                                    @error('short_desc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="long_desc" class="form-control form-control-sm textarea" id="long_desc" cols="30" rows="3">{{ old('long_desc', $event->long_desc) }}</textarea>
                                    @error('long_desc')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date date-selection" id="event_from" data-target-input="nearest">
                                        <input type="text" name="event_from" class="form-control form-control-sm datetimepicker-input" data-target="#event_from"
                                               value="{{ old('event_from', date('m/d/Y h:i A',strtotime($event->event_from)))}}">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date date-selection" id="event_to" data-target-input="nearest">
                                        <input type="text" name="event_to" class="form-control form-control-sm datetimepicker-input" data-target="#event_to"
                                               value="{{ old('event_to', date('m/d/Y h:i A',strtotime($event->event_to))) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date date-selection" id="ticket_available_till" data-target-input="nearest">
                                        <input type="text" name="ticket_available_till" class="form-control form-control-sm datetimepicker-input" data-target="#ticket_available_till"
                                               value="{{ old('ticket_available_till', date('m/d/Y h:i A',strtotime($event->ticket_available_till))) }}">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_social_link" class="form-control form-control-sm" id="event_social_link" placeholder="http://..."
                                           value="{{ old('event_social_link', $event->event_social_link) }}">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_location" class="form-control form-control-sm" id="event_location" placeholder="Enter event location"
                            ...
                            <div class="col-sm-12 col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_location_address" class="form-control form-control-sm" id="event_location_address" placeholder="Enter event location address"
                                           value="{{ old('event_location_address', $event->event_location_address) }}">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="event_location_map" class="form-control form-control-sm" id="event_location_map" cols="30" rows="3"
                                              placeholder="Enter embedded html here...">{{ old('event_location_map', $event->event_location_map) }}</textarea>
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_feature_link" class="form-control form-control-sm" id="event_feature_link" aria-describedby="feature_image_link" placeholder="https://"
                                           value="{{ old('event_feature_link', $event->event_feature_link) }}">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_image_link" class="form-control form-control-sm" id="event_image_link" aria-describedby="image_link" placeholder="https://"
                                           value="{{ old('event_image_link', $event->event_image_link) }}">
                            ...
                            <div class="col-sm-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="event_banner_image_link" class="form-control form-control-sm" id="event_banner_image_link" aria-describedby="banner_image_link" placeholder="https://"
                                           value="{{ old('event_banner_image_link', $event->event_banner_image_link) }}">
                        ...
                        <div class="row p-0">
                            ...
                            @if($org_info_arr)
                                @foreach($org_info_arr as $orgIndex => $org)
                                    <div class="row col-sm-12 col-md-12 pr-0" id="organizer_{{$orgIndex}}">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="org_name_{{$orgIndex}}">Organizer Name<span class="text-danger">*</span></label>
                                                <input type="text" name="organizer_info[{{$orgIndex}}][org_name]" class="form-control form-control-sm" id="org_name_{{$orgIndex}}" placeholder="Enter organizer name"
                                                       value="{{ old("organizer_info.$orgIndex.org_name", $org['org_name']) }}">
                                                @error("organizer_info.$orgIndex.org_name")
                                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                                @enderror
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="org_social_url_{{$orgIndex}}">Organizer Social Link<span class="text-danger">*</span></label>
                                                <input type="text" name="organizer_info[{{$orgIndex}}][org_social_url]" class="form-control form-control-sm" id="org_social_url_{{$orgIndex}}"
                                                       placeholder="Enter organizer url"
                                                       value="{{ old("organizer_info.$orgIndex.org_social_url", $org['org_social_url']) }}">
                                                @error("organizer_info.$orgIndex.org_social_url")
                                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                                @enderror
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="org_social_logo_{{$orgIndex}}">Organizer Logo<span class="text-danger">*</span></label>
                                                <input type="text" name="organizer_info[{{$orgIndex}}][org_social_logo]" class="form-control form-control-sm" id="org_social_logo_{{$orgIndex}}"
                                                       placeholder="Enter organizer logo url"
                                                       value="{{ old("organizer_info.$orgIndex.org_social_logo", $org['org_social_logo']) }}">
                                                @error("organizer_info.$orgIndex.org_social_logo")
                                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                                @enderror
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="org_address_{{$orgIndex}}">Organizer Address<span class="text-danger">*</span></label>
                                                <input type="text" name="organizer_info[{{$orgIndex}}][org_address]" class="form-control form-control-sm" id="org_address_{{$orgIndex}}"
                                                       placeholder="Enter organizer address"
                                                       value="{{ old("organizer_info.$orgIndex.org_address", $org['org_address']) }}">
                                                @error("organizer_info.$orgIndex.org_address")
                                                <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                                @enderror
